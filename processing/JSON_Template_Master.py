#This file has the master template objects that are used in the report generators
#each report JSON object is its own class object

class JSON_Template(object):
	def __init__(self):
		pass

class report_3_1_json(JSON_Template):
	table_3_1 =   {
    "table": "",
    "type": "aggregate",
    "year": "",
    ...
    "borrower-characteristics": [
        ...
        },
        {
            ...
            "minority statuses": [
                ...
                {
                    "minority status": "Others, including Hispanic",
                    "purchasers": [
                        {
                            "count": 0,
                            "name": "Loan was not originated or purchased in calendar year",
        ...
        {
            "characterisitc": "Income as a % of tract median",
            "income brackets": [
                {
                ...
                {
                    "income": "51% to 79% of MSA/MD median",
                    "purchasers": [
                        {
                            "name": "Loan was not originated or purchased in calendar year",
                            "count": 0,
                ...
                {
                    "income": "80% to 99% of MSA/MD median",
                    "purchasers": [
                        {
                            "name": "Loan was not originated or purchased in calendar year",
                            "count": 0,
                ...
                {
                    "income": "100% to 119% of MSA/MD median",
                    "purchasers": [
                        {
                            "name": "Loan was not originated or purchased in calendar year",
                            "count": 0,
    ...
    "census-characteristics": [

        {
            ...
            "compositions": [
                ...
                {
                    "composition": "80% to 100% Minority",
                    "purchasers": [
                        {
                            "name": "Loan was not originated or purchased in calendar year",
                            "count": 0,
        ...
        {
            "characteristic": "Tract Income Classification",
            "income categories": [
                {
                    "income": "Low income",
                    "purchasers": [
